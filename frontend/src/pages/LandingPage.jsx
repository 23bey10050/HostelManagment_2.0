  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--color-bg)', color: 'var(--color-text)' }}>
      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: 750, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 50, flexWrap: 'wrap', justifyContent: 'center' }}>
          {/* Avatar */}
          <div style={{ 
            ...
            <img src="/Ritu_Raj_Singh.png" alt="Ritu Raj Singh" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>

          {/* Details */}
          <div style={{ flex: 1, minWidth: 300, color: '#f7fafc', textAlign: 'left' }}>
            <div style={{ fontSize: 13, color: '#a0aec0', marginBottom: 4, fontWeight: 500 }}>Developed by</div>
            <h2 style={{ fontSize: 32, fontWeight: 800, margin: '0 0 16px 0', color: 'white', letterSpacing: '-0.5px' }}>Ritu Raj Singh</h2>
            <p style={{ fontSize: 14, lineHeight: 1.6, color: '#cbd5e0', margin: '0 0 24px 0', maxWidth: 450 }}>
              Passionate about building innovative solutions that simplify complex processes. Specialized in creating efficient enterprise applications and modern full-stack web platforms.
            </p>
            
            {/* Buttons */}
            <div style={{ display: 'flex', gap: 12 }}>
              <a href="https://www.linkedin.com/in/rituraj2027/" target="_blank" rel="noopener noreferrer" style={{ 
              ...
              <a href="https://github.com/23bey10050" target="_blank" rel="noopener noreferrer" style={{ 
                display: 'inline-flex', alignItems: 'center', gap: 8, 
                padding: '9px 18px', background: '#334155', color: 'white', 
                borderRadius: 6, textDecoration: 'none', fontSize: 13, fontWeight: 600,
                transition: 'background 0.2s'
              }}>
      ...
      {/* ── Footer Copyright ── */}
      <footer style={{ textAlign: 'center', padding: '40px 24px 60px', fontSize: 12, color: 'var(--color-text-soft)' }}>
        <div style={{ color: 'var(--color-text)', marginBottom: 6 }}><strong>Copyright © 2026 Ritu Raj Singh. All rights reserved.</strong></div>

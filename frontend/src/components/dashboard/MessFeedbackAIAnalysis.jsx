    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex flex-col items-center justify-center py-10">
          ...
          <p className="text-gray-600">Generating AI analysis of mess feedback...</p>
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-gray-800">Gemini AI Feedback Analysis</h2>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200 text-sm text-gray-500">
        <p className="flex items-center">
          ...
          Analysis generated by Google's Gemini AI based on collected feedback data.
        </p>
      </div>
    </div>
  );
...
export default MessFeedbackAIAnalysis;
